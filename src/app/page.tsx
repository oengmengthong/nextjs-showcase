          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/games" className="group">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Interactive games with state management and user engagement
                </p>
              </div>
            </Link>

            <Link href="/rich-forms" className="group">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Rich text editors, code editors, and advanced form components
                </p>
              </div>
            </Link>
            ...
            <Link href="/dev-tools" className="group">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Theme switcher, debug panels, and developer utilities
                </p>
              </div>
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/dev-tools" className="block p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-colors">
                    <span className="font-medium text-amber-600 dark:text-amber-400">Developer Tools</span>
                    <p className="text-sm text-gray-600 dark:text-gray-300">Theme switcher, performance monitor & debug panel</p>
                  </Link>
                </div>
              </div>
            </div>
